...
import PickerAndroid from './PickerAndroidItem';
...
export default class PickerAny extends Component {
    ...
    _renderCascadeWheel(pickerData){
        let thirdWheel = this.state.thirdWheelData && (
                <View style={[styles.pickerWheel,{width: (this.state.style.width || width)/3-10}]}>
                    <Picker
                        ref={'thirdWheel'}
        ...
        return (
            <View style={[styles.pickerWrap, {width: this.state.style.width || width}]}>
                <View style={[styles.pickerWheel,{width: (this.state.style.width || width)/3+30}]}>
                    <Picker
                        ref={'firstWheel'}
                ...
                <View style={[styles.pickerWheel,{width: (this.state.style.width || width)/3-20}]}>
                    <Picker
                        ref={'secondWheel'}
